...
def update_user_age(user_info):
    user_info["personal_details"]["age"] += 1
    return user_info
...
def collect_plurals(lst):
    return [word for word in lst if word[-1] == "s"]
